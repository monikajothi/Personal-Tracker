...
.combined-search {
  ...
  height: 46px;
  box-sizing: border-box;
  border: 1px solid rgba(80, 65, 55, 0.18);
  border-radius: 16px;
  background: rgba(255, 255, 255, 0.78);
  overflow: hidden;
}

.combined-search .star-search {
  flex: 1;
  min-width: 0;
  width: auto;
  height: 100%;
...
.combined-search .date-search {
  ...
  /* Hide the actual date text */
  color: transparent;
  font-size: 0;
}

/* Chrome / Edge */
.combined-search .date-search::-webkit-datetime-edit {
  display: none;
}

.combined-search .date-search::-webkit-calendar-picker-indicator {
  display: block;
  width: 18px;
  height: 18px;
  margin: 0;
